...
class BlindingDart(BaseSpell):
    """Sort ultime flêchette aveuglante (Q spell) de Teemo."""
    def __init__(self, damages: List[int], damage_type: List[str], *, stun: bool, blind: bool, bump: bool) -> None:
        """Instancie la classe du sort flêchette aveuglante de Teemo.
    ...
    def apply(self, champions: List[BaseChampion]) -> None:
        """Applique les effets du sort flêchette aveuglante aux champions atteints par le sort.
